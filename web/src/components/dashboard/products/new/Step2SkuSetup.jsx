...
export default function Step2SkuSetup() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        <h3 className="text-2xl font-bold text-gray-900 mb-2">SKU Engine</h3>
            ...
            <div key={sku.id} className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all">
              ...
              <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h4 className="font-semibold text-gray-800 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-[#4F3863] text-white flex items-center justify-center text-xs font-bold">
                    {index + 1}
                  </span>
                ...
                <div className="flex items-center gap-2">
                  <button 
                    ...
                    className="p-2 text-gray-500 hover:text-[#4F3863] hover:bg-[#4F3863]/10 rounded-lg transition-colors"
                    title="Duplicate SKU"
                  >
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                  ...
                  <div className="md:col-span-7 space-y-4">
                    <h5 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Basic Info</h5>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input 
                          ...
                          className={`w-full px-3 py-2 bg-gray-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#4F3863]/20 focus:border-[#4F3863] ${errors[`${index}_skuName`] ? 'border-red-300 bg-red-50' : 'border-gray-200'}`}
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          className={`w-full px-3 py-2 bg-gray-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#4F3863]/20 focus:border-[#4F3863] ${errors[`${index}_skuCode`] ? 'border-red-300 bg-red-50' : 'border-gray-200'}`}
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#4F3863]/20 focus:border-[#4F3863]"
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          className={`w-full px-3 py-2 bg-gray-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#4F3863]/20 focus:border-[#4F3863] ${errors[`${index}_size`] ? 'border-red-300 bg-red-50' : 'border-gray-200'}`}
                  ...
                  <div className="md:col-span-5 space-y-4 border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6">
                    <div className="flex justify-between items-center mb-2">
                      <h5 className="text-xs font-bold text-gray-400 uppercase tracking-wider">Pricing</h5>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <input 
                          ...
                          className={`w-full px-3 py-2 bg-gray-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#4F3863]/20 focus:border-[#4F3863] ${errors[`${index}_mrp`] ? 'border-red-300 bg-red-50' : 'border-gray-200'}`}
                          placeholder="0.00"
                          min="0" step="0.01"
                        />
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          className={`w-full px-3 py-2 bg-gray-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#4F3863]/20 focus:border-[#4F3863] ${errors[`${index}_sellingPrice`] ? 'border-red-300 bg-red-50' : 'border-gray-200'}`}
                          placeholder="0.00"
                          min="0" step="0.01"
                        />
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          className={`w-full px-3 py-2 bg-gray-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#4F3863]/20 focus:border-[#4F3863] ${errors[`${index}_supplierCost`] ? 'border-red-300 bg-red-50' : 'border-gray-200'}`}
                          placeholder="0.00"
                          min="0" step="0.01"
                        />
